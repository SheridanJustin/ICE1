...
public class CardTrick {
    ...
    private static void printInfo() {
        ...
        System.out.println("My name is Justin, no title needed");
        System.out.println();
        
        System.out.println("My career ambitions:");
        System.out.println("-- Familiarize myself with Java");
        System.out.println("-- Master my first coding language!");
	System.out.println();	
